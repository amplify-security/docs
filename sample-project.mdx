...
<Steps titleSize="h3">
  <Step title="Create a new repository">
    ...
    Under **Owner**, select the organization or user you added to Amplify, give a name to your example project, e.g. _my-vulnerable-project_, and create the repository.
    You can also select "Private" if you want to keep it private.
...
If you're using GitLab or another platform, you can for the most part follow the above steps, substituting steps using GitHub's web interface with the equivalent on your VCS platform.
