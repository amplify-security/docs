...
<Card
  title="Amplify's Example Project"
  icon="paste"
  href="https://github.com/amplify-security/amplify-example-project"
  horizontal
>
...
<Steps>
  <Step title="Launch the template" titleSize="h2">
  ...
  <Step title="Include all branches" titleSize="h2">
    Check "Include all branches" to copy the example vulnerable branches from the template repository.
    ![](/images/sample-project-include-all-branches.png)A
  </Step>
  <Step title="Create your repository" titleSize="h2">
  ...
  <Step title="Ensure Amplify can access your repository" titleSize="h2">
  ...
  <Step title="Add your repository to Amplify" titleSize="h2">
  ...
  <Step title="Open a pull request" titleSize="h2">
...
If you're using GitLab or another platform, you can still use the Amplify Example Project by cloning the template like any other repository and pushing it to your own account or group/organization. The following is a demonstration for GitLab, provided you've set up a new project on GitLab:
