...
keys](https://console.amplify.security/console/profile/api-keys) from the web interface.
...
to install the [Amplify Console GitHub App](https://github.com/apps/amplify-console). To do so, visit
the [install page](https://github.com/apps/amplify-console/installations/select_target), select your
