...
app's [agent tools](/agent-tools/overview) — a Slack summary, one Jira issue per finding, a Confluence
write-up. See [adding a delivery step](/agent-tools/using-in-agents#adding-a-delivery-step-to-a-workflow).
