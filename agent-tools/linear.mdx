...
1. Create the bot Linear user. See [the bot account](/agent-tools/connecting#the-bot-account).
...
[Jira example](/agent-tools/using-in-agents#one-issue-per-finding): swap the tools for `Linear_ListTeams`,
