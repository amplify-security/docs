...
A session shows you what the agent is doing as it works:
...
When an agent reaches a wrong conclusion, the tool trail usually shows exactly where it went sideways.
...
| You read the answer | [Outputs](/workflows/outputs) deliver it where your team works |
| Runs when you remember | Runs whenever its trigger fires |
