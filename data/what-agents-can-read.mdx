...
<Note>
  ...
  in are a separate thing: through [integration tools](/integrations/overview), agents can read *and write* Slack,
...
[integration tools](/integrations/overview) — a fixed set of tools per connected app, with nothing destructive
