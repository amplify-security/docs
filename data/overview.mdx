...
| **[Integrations](/integrations/overview)** | The apps your team works in — Slack, Jira, Confluence, Linear, Notion, Asana, Google Docs — which agents can read and write. | Connections |

Projects are what an agent reads *from disk*. Connections are what it queries *over the network* —
including the pull request events that let a workflow fire on its own. Integrations are how it puts results
