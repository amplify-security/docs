...
![Untitled](Ignoring%20Vulnerabilities%2072c980e8a5f44c9fa775836882a45705/Untitled.png)
...
This file mostly follows the familiar syntax of the well-known `.gitignore` file.
The `.gitignore` file specification can be found in the [Git documentation](https://git-scm.com/docs/gitignore).
